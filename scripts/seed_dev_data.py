...
items = [
    ...
    Item(
        ...
        item_text="나 오늘 발표하다가 말이 꼬여서 너무 창피했어.",
        target_response="감정 인정, 위로, 질문",
        hint1_template="친구가 지금 어떤 마음일지 생각해보자.",
        hint2_template="'창피했겠다'처럼 마음을 알아주는 말을 넣어볼 수 있어.",
        verified_example="많이 창피했겠다. 그래도 끝까지 발표한 건 대단해. 어떤 부분이 제일 어려웠어?",
        cvi_score=0.83,
        status="approved",
    ),
    Item(
        ...
        hint1_template="친구가 어떤 도움이 필요할지 생각해보자.",
        hint2_template="'같이 해볼까?'처럼 도와주겠다는 말을 넣어볼 수 있어.",
        verified_example="많이 막막하겠다. 어디서부터 어려운지 같이 보면서 도와줄까?",
        cvi_score=0.83,
        status="approved",
    ),
]
